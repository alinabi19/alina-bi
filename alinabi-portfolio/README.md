<p align="center" width="100%">
    <img height="100" src="https://github.com/said7388/alinabi-portfolio/assets/77630868/c0064908-cd5f-4751-a77c-eba90a62b55c">
</p>
...
```bash
git clone https://github.com/<YOUR_GITHUB_USERNAME>/alinabi-portfolio.git
cd alinabi-portfolio
```
...
docker build -t alinabi-portfolio:dev -f Dockerfile.dev .

# Run the container
docker run -p 3000:3000 --name portfolio-dev alinabi-portfolio:dev
...
docker build -t alinabi-portfolio:prod -f Dockerfile.prod .

# Run the production container
docker run -p 3000:3000 --name portfolio-prod alinabi-portfolio:prod
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/said7388/alinabi-portfolio)
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/said7388/alinabi-portfolio)
...
# Run
docker run -d -p 80:3000 --name portfolio alinabi-portfolio:prod
...
- ⭐ [Star the repository](https://github.com/said7388/alinabi-portfolio/stargazers)
- � [Report bugs](https://github.com/said7388/alinabi-portfolio/issues)
- � [Suggest features](https://github.com/said7388/alinabi-portfolio/discussions)

---

![GitHub stars](https://img.shields.io/github/stars/said7388/alinabi-portfolio?style=social)
![GitHub forks](https://img.shields.io/github/forks/said7388/alinabi-portfolio?style=social)
![GitHub issues](https://img.shields.io/github/issues/said7388/alinabi-portfolio)
![GitHub license](https://img.shields.io/github/license/said7388/alinabi-portfolio)
